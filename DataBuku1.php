...
?>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="DataBuku.php" method="post" id="edit">
                                        <div class="form-group">
                                            <label>ID Buku</label>
                                            <input type="number" class="form-control" name="IdBuku" value = "<?php echo $result['ID_Buku'] ?>">
                                        </div>

                                        <div class="form-group">
                                            <label>Judul Buku</label>
                                            <input type="text" class="form-control" name="JudulBuku" value = "<?php echo $result['Judul_Buku'] ?>">
                                        </div>

                                        <div class="form-group">
                                        <label>Pengarang</label>
                                            <input type="text" class="form-control" name="Pengarang" value = "<?php echo $result['Pengarang'] ?>">
                                        </div>

                                        <div class="form-group">
                                            <label>Penerbit</label>
                                            <input type="text" class="form-control" name="Penerbit" value = "<?php echo $result['Penerbit'] ?>">
                                        </div>

                                        <div class="form-group">
                                            <label>Tahun Terbit</label>
                                            <input type="date" class="form-control" name="TahunTerbit" value = "<?php echo $result['Tahun_Terbit'] ?>">
                                        </div>
                                </div>
